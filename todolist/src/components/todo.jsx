...
export default function Todo() {
  const [tasks, setTasks] = useState([
    {id:uuidv4(),title:'test',state:true},
    {id:uuidv4(),title:'test 2',state:false},
    {id:uuidv4(),title:'test 3',state:true}
  ]);
  ...
  return (
    <div className="flex flex-col gap-5 w-[700px] p-5 shadow bg-white">
      ...
      <div className="max-h-[400px] overflow-y-auto">
        {tasks.map((task, i)=>{
          return <Task key={i} deleteTask={deleteTask} toggleTaskState={toggleTaskState} task={task}/>
        })}
